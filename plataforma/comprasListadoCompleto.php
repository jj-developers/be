...
$idCliente=$_GET['idCliente'];
  ...
  if ($idCliente!=''){
    $criteriocliente="and com_idProveedor=$idCliente";
  }
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <select class="form-control select2 select2" data-dropdown-css-class="select2" id="idCliente" name="idCliente">
                                    ...
                                    <?php
                                    $query="SELECT * from th_proveedores where prov_estatus=1";
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      $quertytotal2="SELECT * FROM th_compras where com_idCompra!='' $criteriofecha $criteriocliente";
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      $subtotalnew=0; 
                      $quertytotal="SELECT sum(com_montocompra) as totalmonto FROM th_compras where com_idCompra!='' $criteriofecha $criteriocliente";
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      where com_idCompra!='' $criteriofecha $criteriocliente";
