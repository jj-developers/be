...
<form id="formnuevo" action="consultas/actualizacionProducto" method="POST" autocomplete="off" enctype="multipart/form-data">
  <section class="content">
      <div class="container-fluid">
       <!-- <div class="card card-default">
        ...
        -->
        <input type="hidden" class="form-control" id="pro_idProducto" name="pro_idProducto" value="<?php echo $idProducto ?>">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="pro_nombreproducto" name="pro_nombreproducto" value="<?php echo $regprod['pro_nombreproducto'] ?>">
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>SKU</label>
                  <div class="input-group">
                    <input type="text" class="form-control" id="pro_sku" name="pro_sku" value="<?php echo $regprod['pro_sku'] ?>">
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label>Tags</label>
                  <div class="input-group">
                    <input type="text" class="form-control" id="pro_tags" name="pro_tags" value="<?php echo $regprod['pro_tags'] ?>">
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2" id="pro_estatus" name="pro_estatus">
                    <?php if ($estatus==1){ ?>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  $res = mysqli_query($con,$query);
//where cat_nombrecategoria='$idcategoria'
                   //where cat_nombrecategoria='$idcategoria'
                  $query2="select * from th_cat_categorias";
                  $res2 = mysqli_query($con,$query2);
                  ?>
                  <select class="form-control select2 select2" id="pro_idCategoria" name="pro_idCategoria">
                                <?php
                                while ($Usuario = mysqli_fetch_array($res)) {
                                  if($Usuario['cat_idCategoria']==$idcategoria){
                                    echo '<option selected value="' . $Usuario['cat_nombrecategoria'] . '">'.$Usuario['cat_nombrecategoria']. '</option>';

                                  }else{
                                    echo '<option value="' . $Usuario['cat_nombrecategoria'] . '">'.$Usuario['cat_nombrecategoria']. '</option>';
                                }
                              }
                                ?>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  $query2="select * from th_cat_subcategorias";
                  $res2 = mysqli_query($con,$query2);
                  ?>
                  <select class="form-control select2 select2" id="pro_idSubcategoria" name="pro_idSubcategoria">
                                <?php
                                while ($Usuario2 = mysqli_fetch_array($res2)) {
                                  //where subcat_nombresubcategoria='$idsubcategoria'
                                  if($idsubcategoria==$Usuario2['subcat_idSubCategoria']){
                                    echo '<option selected value="' . $Usuario2['subcat_nombresubcategoria'] . '">'.strtoupper($Usuario2['subcat_nombresubcategoria']). '</option>';

                                  }else{
                                    echo '<option value="' . $Usuario2['subcat_nombresubcategoria'] . '">'.strtoupper($Usuario2['subcat_nombresubcategoria']). '</option>';
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Marca</label>
                  <input type="text" class="form-control" id="pro_marca" name="pro_marca" value="<?php echo $regprod['pro_marca'] ?>" >              
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" id="pro_preciooro" name="pro_preciooro" value="<?php echo $regprod['pro_preciooro'] ?>" >
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" id="pro_preciopremium" name="pro_preciopremium" value="<?php echo $regprod['pro_preciopremium'] ?>" >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" id="pro_precioplatino" name="pro_precioplatino" value="<?php echo $regprod['pro_precioplatino'] ?>" >
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <textarea class="form-control" rows="3" id="pro_descripcion" name="pro_descripcion" ><?php echo $regprod['pro_descripcion'] ?></textarea>
                  </div>
                </div>
              </div>
 ...
 <div class="row" id="tablapaquetes">
  ...
  <?php } ?>
  <div id="formnuevo" class="card-footer" id="botonenviar">
    <a href="javascript:history.back()" rel="noopener" class="btn btn-info float-left" style="margin-right: 5px;"><i class="fas fa-edit"></i> Regresar</a>
            <button type="submit" id="guardar" class="btn btn-success float-right">Guardar Datos</button>
          </div>
            </div>
          </div>
        </div>
