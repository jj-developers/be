        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Conciliación de pagos</li>
            </ol>
          </div>
        </div>
      </div>
    </section>
    <form method="post" action="conciliaciondepagosexcel">
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
         <form action="" method="POST" autocomplete="off">
          <div class="card-header">
            <h3 class="card-title">Rango de fechas del reporte</h3>
          </div>
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" id="fechaInicio" name="fechaInicio" placeholder="Fecha inicial del reporte">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate2" id="fechaFin" name="fechaFin" placeholder="Fecha final del reporte">
