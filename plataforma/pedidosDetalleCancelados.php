            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-success float-right" style="margin-right: 5px;" data-toggle="modal" data-target="#cancelarPedido">
...
<div id="cancelarPedido" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header"><b>ACTIVAR PEDIDO</b>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
        <blockquote class="quote-success">
                  <p>¿Estás seguro que deseas activar el Pedido <b><?php echo $regpedido['ped_foliopedido'] ?>?</b></p>
                  <a href="#" target="_new"><small>El pedido sera activado, con esta acción pasará al estatus de <b>Pendiente</b> para poder continuar con el proceso de aceptación y posterior entrega</small></a>
                </blockquote>
                  </div>                
                 <input type="hidden" class="form-control" id="idPedidoActivar" name="idPedidoActivar" value="<?php echo $idPedido ?>">
                 ...
                 <button type="button" class="btn btn-success" onclick="activarPedido()">Activar pedido</button> 
        </div>
