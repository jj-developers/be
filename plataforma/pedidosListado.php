    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Listado de pedidos por confirmar</h3>
          ...
          <table id="" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php 
                  ...
                  ?>
                      <tr>
                       <td><a href="pedidosDetalle?idPedido=<?php echo $registro['ped_idPedido'] ?>">
...
<?php if ($_GET['delete']=='true'){ ?>
    ...
    var Toast = Swal.mixin({
                    ...
                    $(document).ready(function() {
                      Toast.fire({
                        icon: 'success',
                        title: 'El pedido fue CANCELADO correctamente, este ya no esta siendo afectado en la cuenta del Cliente'
                      })
                    });
  </script>
<?php } ?>
...
<?php if ($_GET['activate']=='true'){ ?>
    ...
    var Toast = Swal.mixin({
                    ...
                    $(document).ready(function() {
                      Toast.fire({
                        icon: 'success',
                        title: 'El pedido fue ACTIVADO de manera correcta y ahora esta en proceso de aprobación'
                      })
                    });
  </script>
<?php } ?>