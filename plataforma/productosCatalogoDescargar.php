  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Descargar catálogo de productos</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Descargar catalogo de productos por categorias</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <legend>Elije las categorias a descargar</legend>
              <div class="col-md-6">
            ...
            <button type="submit" class="btn btn-success">Descargar catalog</button>
          </div> 
          </div>          
        </div>
        </div>
