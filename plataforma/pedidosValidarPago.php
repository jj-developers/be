            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    ...
                    <small class="float-right">Fecha: <?php echo $regpedido['ped_fechacreado'] ?></small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <a href="pedidosValidarPago=<?php echo $idPedido?>" rel="noopener" class="btn btn-success float-right" style="margin-right: 5px;"><i class="fas fa-edit"></i> Validar pago</a>
                  <?php } ?>
