    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Listado de pedidos por entregar y/o facturar</h3>
          ...
          <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php 
                  ...
                  where ped.ped_estatus=7";
                  $res = mysqli_query($con,$query);
                      while ($registro = mysqli_fetch_array($res)) {
                        $estatus=$registro['ped_estatus'];
                        if ($estatus==7){$b='success';}
                  ?>
                      <tr>
                       <td><a href="pedidosDetalleEntregar?idPedido=<?php echo $registro['ped_idPedido'] ?>"><b>
                        <?php echo $registro['ped_foliopedido'] ?></b></a></td>
                        <td><?php echo $registro['ped_fechacreado'] ?></td>
                       <td><?php echo strtoupper($registro['usr_nombrenegocio']) ?></td>
...
<?php if ($_GET['response']=='true'){ ?>
    ...
    var Toast = Swal.mixin({
                    ...
                    $(document).ready(function() {
                      Toast.fire({
                        icon: 'success',
                        title: 'El pedido fue entregado al cliente se continua con el proceso del pedido'
                      })
                    });
  </script>
<?php } ?>