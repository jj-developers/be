            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <b>Fecha de Solicitud:</b> <?php echo $regpedido['ped_fechacreado'] ?><br>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="pedidosImprimircompleto?idPedido=<?php echo $idPedido?>" rel="noopener" target="_blank" class="btn btn-dark float-left" style="margin-right: 5px;"><i class="fas fa-print"></i> Imprimir</a>
                  ...
                  ?>
                  <!-- <a href="<?php echo $regpedido['factura_pdf']; ?>" rel="noopener" class="btn btn-warning float-right " style="margin-right: 5px;" target="_new"><i class="fas fa-search"></i> Ver factura </a> -->
                  ...
                  <?php if ($pagoestatus==2){ ?>
                  <a href="pedidosValidarPagos?idPedido=<?php echo $idPedido?>" rel="noopener" class="btn btn-success float-right" style="margin-right: 5px;"><i class="fas fa-edit"></i> Validar pago</a>
                  <?php } ?>
