...
<!-- Mirrored from bebifydemo.sedmex.com/checkout/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Dec 2023 06:17:31 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel='stylesheet' id='thwcfd-checkout-style-css'
        href='wp-content/plugins/woo-checkout-field-editor-pro/public/assets/css/thwcfd-public.min1e39.css?ver=6.4.2'
        media='all' />
    ...
    var wc_checkout_params = {
        "ajax_url": "\/wp-admin\/admin-ajax.php",
        "wc_ajax_url": "\/?wc-ajax=%%endpoint%%",
        "update_order_review_nonce": "07d288647a",
        ...
        "is_checkout": "1",
        "debug_mode": "",
        "i18n_checkout_error": "Error procesando el pedido. Por favor, int\u00e9ntalo de nuevo"
    };
    </script>
    <script src="wp-content/plugins/woocommerce/assets/js/frontend/checkout.mined84.js?ver=8.3.1" id="wc-checkout-js"
        defer data-wp-strategy="defer"></script>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed0647.json?url=https%3A%2F%2Fbebifydemo.sedmex.com%2Fcheckout%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embedd3a2?url=https%3A%2F%2Fbebifydemo.sedmex.com%2Fcheckout%2F&amp;format=xml" />
...
<body data-rsssl=1
    class="page-template-default page page-id-14 wp-custom-logo wp-embed-responsive theme-porto woocommerce-checkout woocommerce-page woocommerce-no-js login-popup full blog-1 elementor-default elementor-kit-1724">
    ...
    <div class="page-wrapper">
        ...
        <div class="woo-page-header page-header-8">
            <ul class="breadcrumb text-center">
                <li class="">
                    <a href="cart/index.html">Carrito de Compras</a>
                </li>
                <li class="current">
                    <i class="delimiter delimiter-2"></i>
                    <a href="index.html">Detalles del Pedido</a>
                </li>
                <li class="disable">
                    <i class="delimiter delimiter-2"></i>
                    ...
                    <div class="main-content col-lg-12">
                        ...
                        <div id="content" role="main">
                            ...
                            <article class="post-14 page type-page status-publish hentry">
                                ...
                                <h2 class="entry-title" style="display: none;">Checkout</h2><span class="vcard"
                                            ...
                                            <div class="featured-box align-left">
                                                <div class="box-content">
                                                    ...
                                                    <p class="form-row form-row-first">
                                                        <input type="text" name="coupon_code" class="input-text py-0"
                                                            placeholder="Código de cupón" id="coupon_code" value="" />
                                                    </p>
                                                    <p class="form-row form-row-last">
                                                        <button type="submit"
                                                            class="btn button wc-action-btn wc-action-sm"
                                                            name="apply_coupon" value="Aplicar cupón">Aplicar
                                                            cupón</button>
                                                    </p>
                                                    <div class="clear"></div>
                                                </div>
    ...
    where c.IdCliente=$usr_idUsuario and c.Estatus=1 and pm.IdMembresia=$TipoCosto";
    ...
    $sqldesc="SELECT * FROM  descuentos d WHERE d.Estatus=1 
    ...
    while ($regcarrito=mysqli_fetch_array($rescarrito)){
        ...
        $sqlSaldo="SELECT * from usuarios u
        inner join personas p on p.IdPersona=u.IdPersona
        INNER JOIN empresas e on e.IdEmpresa=p.IdEmpresa
        inner join creditoempresa c on e.IdCreditoEmpresa=c.IdCreditoEmpresa WHERE c.Estatus=1 and u.Estatus=1 and u.IdUsuario=$usr_idUsuario";

        $resSaldo=mysqli_query($con,$sqlSaldo);
        $daasaldo=mysqli_fetch_array($resSaldo);
        if($daasaldo){
          $montodisponible=$daasaldo['MontoCredito'];
          $montoAdeudado=$daasaldo['MontoAdeudado'];
          $credito=(($montodisponible-$montoAdeudado)-($subtotalnew+$ivaD+$costoEnvio));
        }
      ?>


                                        <div class="woocommerce-notices-wrapper"></div>
                                        <form name="checkout" id="crearpedido" method="post"
                                            class="checkout woocommerce-checkout" action="">

                                            <input name="idDescuentoAp" id="idDescuentoAp" type="hidden">
                                            <input name="valorDescuentoAp" id="valorDescuentoAp" type="hidden">
                                            <input type="hidden" id="subtotalCaVa" name="subtotalCaVa"
                                                value="<?php echo $subtotalnew+$ivaD ?>">
                                            <input type="hidden" id="montoDisD" name="montoDisD"
                                                value="<?php echo $montodisponible ?>">
                                            <input name="costoenvip" id="costoenvip" type="hidden"
                                                value="<?php echo $costoEnvio; ?>">
                                            <input type="hidden" id="idClienteSolicita" name="idClienteSolicita"
                                                value="<?php echo $usr_idUsuario ?>">
                                            <input type="hidden" id="montodisponible" name="montodisponible"
                                                value="<?php echo $montodisponible ?>">
                                            <input type="hidden" id="subtotal" name="subtotal"
                                                value="<?php echo $subtotalnew ?>">


                                            <input type="hidden" id="total" name="total"
                                                value="<?php echo $subtotalnew+$ivaD ?>">
                                            <input type="hidden" id="saldocarrito" name="saldocarrito"
                                                value="<?php echo ($montodisponible-($subtotalnew+$ivaD+$costoEnvio)) ?>">
                                            <input type="hidden" id="descuentoEnv" name="descuentoEnv" value="0">
                                            <input type="hidden" id="descuentoEnvId" name="descuentoEnvId" value="">
                                            <input type="hidden" id="costoEnvioen" name="costoEnvioen"
                                                value="<?php echo $costoEnvio; ?>">
...
<?php if($credito>=0){ ?>
                                                        ...
                                                        <div class="box-content">
                                                            ...
                                                            <div class="woocommerce-billing-fields clearfix">
                                                                ...
                                                                <div class="woocommerce-billing-fields__field-wrapper">
                                                                    <p class="form-row form-row-wide thwcfd-required thwcfd-field-wrapper thwcfd-field-text validate-required"
                                                                        id="billing_company_field" data-priority="10">
                                                                        <label for="billing_company"
                                                                            class="">Sucursal&nbsp;<abbr
                                                                                class="required"
                                                                                title="obligatorio">*</abbr></label><span
                                                                            class="woocommerce-input-wrapper"><select
                                                                                class="form-row form-row-wide thwcfd-required thwcfd-field-wrapper thwcfd-field-text validate-required"
                                                                                data-placeholder="Select an option"
                                                                                data-minimum-results-for-search="Infinity"
                                                                                id="shop-shipping-checkout-company" required
                                                                                name="shop-shipping-checkout-company"> 
                                                                                <option value="0">Elige una sucursal
                                                                                </option>
                                                                                <?php // consulto sucursales 
                                    $sucursales="SELECT se.IdSucursalEmpresa,s.Nombre,s.Encargado from empresas e INNER JOIN sucursalesempresas se on e.IdEmpresa=se.IdEmpresa
                                    ...
                                    where u.IdUsuario=$usr_idUsuario and s.Estatus=1";
                                    $resultado=mysqli_query($con,$sucursales);
                                    while ($regsucursales=mysqli_fetch_array($resultado)) {
                                    ?>
                                                                                <option
                                                                                    value="<?php echo $regsucursales['IdSucursalEmpresa'] ?>">
                                                                                    <?php echo $regsucursales['Nombre'] ?>
                                                                                </option>
                                                                                <?php } ?>
                                                                            </select></span>
                                                                    </p>
                                                                    ...
                                                                    <p class="form-row form-row thwcfd-required thwcfd-field-wrapper thwcfd-field-text validate-required"
                                                                        id="billing_first_name_field"
                                                                        data-priority="20"><label
                                                                            for="billing_first_name" class="">Contacto
                                                                            de Sucursal&nbsp;<abbr class="required"
                                                                                title="obligatorio">*</abbr></label><span
                                                                    ...
                                                                    <p class="form-row form-row-wide  address-field thwcfd-required thwcfd-field-wrapper thwcfd-field-text validate-required"
                                                                        id="billing_address_1_field" data-priority="40">
                                                                        <label for="direccion" class="">Dirección de la
                                                                            Sucursal&nbsp;<abbr class="required"
                                                                                title="obligatorio">*</abbr></label><span
                                                                            class="woocommerce-input-wrapper"><input
                                                                                type="text" class="input-text "
                                                                                id="direccion" name="direccion"
                                                                                placeholder="Calle número" value="" required
                                                                                autocomplete="direccion" /></span>
                                                                    </p>
                                                                    <p class="form-row form-row-wide thwcfd-required thwcfd-field-wrapper thwcfd-field-tel validate-required validate-phone"
                                                                        id="billing_phone_field" data-priority="50">
                                                                        <label for="billing_phone"
                                                                            ...
                                                                            class="woocommerce-input-wrapper"><input
                                                                                ...
                                                                                id="telefonosuc" name="telefonosuc"
                                                                                placeholder="" value="" required
                                                                                autocomplete="tel" /></span>
                                                                    </p>
                                                                    <p class="form-row form-row-wide thwcfd-required thwcfd-field-wrapper thwcfd-field-email validate-required validate-email"
                                                                        id="billing_email_field" data-priority="60">
                                                                        <label for="billing_email" class="">Dirección de
                                                                            correo electrónico&nbsp;<abbr
                                                                                class="required"
                                                                                title="obligatorio">*</abbr></label><span
                                                                            class="woocommerce-input-wrapper"><input
                                                                                class="input-text "
                                                                                id="shop-shipping-checkout-email"
                                                        ...
                                                        <div class="checkout-order-review align-left">
                                                            <div class="box-content featured-boxes">
                                                                <h3 id="order_review_heading"
                                                                    class="text-md text-uppercase">Tu pedido</h3>
                                                                ...
                                                                <div id="order_review"
                                                                    ...
                                                                    <table
                                                                        class="shop_table  woocommerce-checkout-review-order-table mb-0">
                                                                        <thead>
                                                                            <tr>
                                                                            ...
                                                                            <tr class="border-bottom-0 cart_item">
                                                                                <td class="product-name line-height-sm">
                                                                                    <img loading="lazy" decoding="async"
                                                                                        ...
                                                                                        class="alignleft"
                                                                                        alt="" /><?php echo $regcarrito['Nombre'] ?>&nbsp;
                                                                                    <strong
                                                                                        class="product-quantity font-weight-medium">&times;&nbsp;<?php echo $regcarrito['Cantidad'];echo " = ";echo "$".$regcarrito['Precio']*$regcarrito["Cantidad"]; ?></strong>
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                            ...
                                                                                            value="flat_rate:1"
                                                                                            class="shipping_method porto-control-input" />
                                                                                        <span
                                                                                            class="woocommerce-Price-amount amount"><bdi><span
                                                                                                    class="woocommerce-Price-currencySymbol">&#36;</span><?php echo number_format($costoEnvio, 2, '.', ',') ?></bdi></span>
                                                                                    </div>
                                                                                </td>
                                                                                </li>
                                                                                </ul>
...
<?php if($credito>=0) {?>
                                                                        ...
                                                                        <ul
                                                                            ...
                                                                            <li
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul
                                                                                        class="wc-bacs-bank-details order_details bacs_details">
                                                                                        <li class="bank_name">
                                                                                            <strong>Grupo Primo Bebidas
                                                                                                S.A de C.V.</strong>
                                                                                        </li>
                                                                                        </strong>
                                                                            </li>
                                                                            <li class="bank_name">Banco:
                                                                                <strong>BBVA</strong></li>

                                                                            <li class="account_number">Número de cuenta:
                                                                                <strong>0074 4753 18 0121
                                                                                    476092</strong></li>
                                                                            <li class="sort_code">Cuenta CLABE:
                                                                                <strong>012180001214760920</strong></li>
                                                                        </ul </div>
                                                                        </li>
                                                                        </ul>
                                                                        ...
                                                                        <div class="form-row place-order">
                                                                            <noscript>
                                                                                Debido a que tu navegador no es
                                                                                compatible con JavaScript o lo tiene
                                                                                desactivado, por favor, asegúrate de
                                                                                hacer clic en el botón <em>Actualizar
                                                                                    totales</em> antes de realizar tu
                                                                                pedido. De no hacerlo, se te podría
                                                                                cobrar más de la cantidad indicada
                                                                                arriba. <br /><button type="submit"
                                                                                    class="button alt"
                                                                                    name="woocommerce_checkout_update_totals"
                                                                                    value="Actualizar totales">Actualizar
                                                                                    totales</button>
                                                                            </noscript>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <p>Tus datos personales se
                                                                                        utilizarán para procesar tu
                                                                                        pedido, respaldar tu experiencia
                                                                                        en este sitio web y para otros
                                                                                        fines descritos en nuestra <a
                                                                                            href="https://bebifydemo.sedmex.com/terminos-y-condiciones/"
                                                                                ...
                                                                                <div class="woocommerce-terms-and-conditions"
                                                                                    ...
                                                                                    <h1 style="text-align: left">
                                                                                        <strong>Aviso de
                                                                                            Privacidad</strong></h1>
                                                                                    <p>.porto-u-8249.porto-u-heading{text-align:center}
                                                                                    </p>
                                                                                    <p><strong>Aviso De Privacidad
                                                                                        </strong><strong>Bebify</strong>
                                                                                    </p>
                                                                                    <p>Conforme a la Ley Federal de
                                                                                        Protección de Datos Personales
                                                                                        en Posesión de los Particulares,
                                                                                        le invitamos a revisar
                                                                                        detenidamente los Términos y
                                                                                        Condiciones presentes en este
                                                                                        documento. La aportación de sus
                                                                                        Datos Personales o Datos
                                                                                        Sensibles implica la aceptación
                                                                                        de los siguientes términos:</p>
                                                                                    <p><strong>Responsable de
                                                                                            Datos:</strong> Grupo Primo
                                                                                        Bebidas, con domicilio en Fuego
                                                                                        #61, Jardines Del Pedregal,
                                                                                        Álvaro Obregón, 01900, Ciudad de
                                                                                        México, México, actuará como
                                                                                        responsable de los datos
                                                                                        personales, conforme a lo
                                                                                        establecido en la fracción I del
                                                                                        artículo 16 de la Ley.</p>
                                                                                    <p><strong>Definiciones:</strong>
                                                                                        Los términos «Datos Personales»
                                                                                        y «Datos Sensibles» tendrán la
                                                                                        acepción que se les atribuye en
                                                                                        el artículo 3 de la Ley.</p>
                                                                                    <p><strong>Finalidades del
                                                                                            Tratamiento:</strong></p>
                                                                                    <ul>
                                                                                        <li>Su información personal,
                                                                                            considerada sensible según
                                                                                            la Ley, se empleará para
                                                                                            brindar los servicios y
                                                                                            productos solicitados,
                                                                                            comunicar cambios en los
                                                                                            mismos y evaluar la calidad
                                                                                            del servicio.</li>
                                                                                    </ul>
                                                                                    <p><strong>Medidas de
                                                                                            Seguridad:</strong> Una vez
                                                                                        proporcionados, sus Datos
                                                                                        Personales o Datos Sensibles se
                                                                                        conservarán en entornos seguros,
                                                                                        con acceso restringido a
                                                                                        personas con las que el
                                                                                        responsable tenga relación
                                                                                        jurídica. Se implementarán
                                                                                        medidas de seguridad apropiadas
                                                                                        para proteger su uso.</p>
                                                                                    <p><strong>Autorización
                                                                                            Expresa:</strong> Al
                                                                                        entregar sus datos, usted
                                                                                        autoriza expresamente su
                                                                                        tratamiento por parte del
                                                                                        responsable, salvo que
                                                                                        manifieste su oposición por los
                                                                                        medios establecidos en la Ley.
                                                                                    </p>
                                                                                    <p><strong>Derechos ARCO:</strong>
                                                                                        Usted podrá ejercer en todo
                                                                                        momento sus derechos de acceso,
                                                                                        rectificación, cancelación u
                                                                                        oposición, de acuerdo con lo
                                                                                        dispuesto en la Ley. Para ello,
                                                                                        puede comunicarse mediante el
                                                                                        correo electrónico <a
                                                                                            href="mailto:hola@bebify.mx">hola@bebify.mx</a>
                                                                                        o visitar <a
                                                                                            href="https://www.bebify.mx/">https://www.bebify.mx</a>.
                                                                                    </p>
                                                                                    <p><strong>Transferencias y
                                                                                            Modificaciones:</strong> En
                                                                                        el caso de Datos Sensibles, será
                                                                                        informado sobre cualquier
                                                                                        transferencia a terceros,
                                                                                        notificándose por cualquier
                                                                                        medio disponible. Cualquier
                                                                                        modificación a este aviso de
                                                                                        privacidad se publicará en <a
                                                                                            href="https://www.bebify.mx/avisodeprivacidad">https://www.bebify.mx/avisodeprivacidad</a>.
                                                                                    </p>
                                                                                    <p><strong>Consentimiento para Otros
                                                                                            Fines:</strong> En caso de
                                                                                        requerir utilizar sus datos para
                                                                                        fines distintos a los
                                                                                        mencionados, se le informará y
                                                                                        se solicitará su autorización
                                                                                        expresa.</p>
                                                                                    <p>Agradecemos su confianza en
                                                                                        Bebify. Para más información,
                                                                                        contáctenos a través del correo
                                                                                        electrónico mencionado
                                                                                        anteriormente.</p>
                                                                                    <p><strong>¡Gracias por elegir
                                                                                        </strong><strong>Bebify</strong><strong>!</strong>
                                                                                    </p>
                                                                                    <p>&nbsp;</p>
                                                                                </div>
                                                                            ...
                                                                            <tr class="cart-subtotal">
                                                                                <th>
                                                                                    <h4 class="mb-0">Credito disponible
                                                                                        despues de mi compra</h4>
                                                                                </th>
                                                                                <?php 
                                                                           ...
                                                                           ?>
                                                                                <td><span
                                                                                        class="woocommerce-Price-amount amount"><bdi><span
                                                                                                class="woocommerce-Price-currencySymbol">&#36;</span><?php echo number_format($credito,2)?></bdi></span>
                                                                                </td>
                                                                            </tr>

                                                                            <button type="button" id="btnEnviarPedido"
                                                                                class="button alt btn-v-dark w-100 mt-3 py-3"
                                                                                name="woocommerce_checkout_place_order"
                                                                                value="Realizar el pedido"
                                                                                data-value="Realizar el pedido">Realizar
                                                                                el pedido</button><img
                                                                                src="https://bebifydemo.sedmex.com/wp-content/themes/porto/images/ajax-loader.gif"
                                                                                srcset="https://bebifydemo.sedmex.com/wp-content/themes/porto/images/ajax-loader@2x.gif 2x"
                                                                                alt="loader">
                                                                            ...
                                                                            <td><span
                                                                                    class="woocommerce-Price-amount amount"><bdi><span
                                                                                            class="woocommerce-Price-currencySymbol">Tu
                                                                                            credito disponible no es
                                                                                            suficiente.</bdi><b> Tu compra no puede ser proceda.</b></span>
                                                                            </td>
                                                                            <?php
                                                                        }
                                                                            ?>
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                value="0442df7a7a"><input type="hidden"
    ...
    <script src="wp-content/plugins/woo-checkout-field-editor-pro/public/assets/js/thwcfd-public.min001e.js?ver=2.0.0"
    ...
    var elementorFrontendConfig = {
        ...
        "post": {
            "id": 14,
            "title": "Checkout%20%E2%80%93%20bebify",
            "excerpt": "",
            "featuredImage": false
        }
    };
...
<!-- Mirrored from bebifydemo.sedmex.com/checkout/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Dec 2023 06:17:39 GMT -->
