				...
				events: function() {
					...
					$( document ).on( 'click', '.quickview', function( e ) {
						...
						if ( !$.fn.elevateZoom && !$( '#porto-script-jquery-elevatezoom' ).length ) {
							...
							$( js ).appendTo( 'body' ).attr( 'src', js_porto_vars.ajax_loader_url.replace( '/images/ajax-loader@2x.gif', 'js/libs/jquery.elevatezoom.min.html' ) );
						}
						...
						if ( $.fn.fancybox ) {
							...
							$( js1 ).appendTo( 'body' ).on( 'load', function() {
								init_quick_view_window();
							} ).attr( 'src', js_porto_vars.ajax_loader_url.replace( '/images/ajax-loader@2x.gif', 'js/libs/jquery.fancybox.min.html' ) );
						}
