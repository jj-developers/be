...
<!-- Mirrored from bebifydemo.sedmex.com/contacto/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Dec 2023 06:15:49 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta property="og:description"
        content="Hola!¡Hola!Nos alegra recibir tus mensajes. Si tienes preguntas, sugerencias o necesitas más detalles sobre nuestros productos y servicios, estamos aquí para ayudarte.Utiliza el formulario de contacto o escríbenos a nuestro correo electrónico o WhatsApp.¡Gracias por elegir Bebify! Estamos aquí para ofrecerte la mejor experiencia. UbicaciónCDMX&hellip;" />
    ...
    <link rel='stylesheet' id='elementor-post-1757-css'
        href='wp-content/uploads/elementor/css/post-1757ef2d.css?ver=1701108841' media='all' />
    <link rel='stylesheet' id='elementor-post-888-css'
        href='wp-content/uploads/elementor/css/post-8885222.css?ver=1701111667' media='all' />
    ...
    .coupon-sale-text .elementor-heading-title,
    .coupon-sale-text.porto-heading {
        position: relative;
        padding-left: .265em;
        display: inline-block
    }
    ...
    .no-bottom-border .divider-line>.product-col {
        border-bottom: none;
        border-top: 1px solid rgba(0, 0, 0, .09)
    }

    .no-bottom-border .divider-line>.product-col:nth-child(1),
    .no-bottom-border .divider-line>.product-col:nth-child(2) {
        border-top: none
    }

    @media (min-width:768px) {
        .no-bottom-border .divider-line>.product-col:nth-child(3) {
            border-top: none
        }
    }

    .section-product-categories .thumb-info img {
        display: none
    }

    .section-product-categories ul.products li.product-category .thumb-info {
        min-height: none;
        background: #222529;
        min-height: 50px
    }
    ...
    .widget_recent_reviews .product_list_widget li {
        background: #fff;
        text-align: left;
        padding: 2.5rem 1.5rem 3rem 120px;
        display: -ms-flexbox;
        display: flex;
        -ms-flex-align: start;
    ...
    .widget_recent_reviews .description {
        margin-top: 1rem;
        padding-left: 2rem
    }

    .widget_recent_reviews .description:before {
        content: "“";
    ...
    .porto-ibanner .porto-ibanner-layer>.elementor-widget-wrap>div {
        width: auto
    }
    ...
    .brand-section .elementor-widget-wrap {
        background: #222529;
        border: 1.45em solid #c0c0c2;
        padding: 2.25em .75em 3.75em;
        text-align: center;
        justify-content: center
    }

    .brand-section .coupon-sale-text .elementor-heading-title:after {
        content: "";
        position: absolute;
        width: 10%;
        height: 3px;
    ...
    .row-bg-dark .elementor-row {
        background: #222529
    }

    .mb-0 .porto-sicon-box {
        margin-bottom: 0
    }

    .bg-light .porto-products {
        background-color: #fff
    }

    .brands-slider .elementor-widget-wp-widget-media_image {
    ...
    .position-static>.elementor-column-wrap>.elementor-widget-wrap,
    .elementor-section .elementor-container,
    .elementor-section .elementor-container>.elementor-row {
        position: static
    }

    .pc-thumb-info-style-1 .elementor-image-box-content {
        display: flex;
        flex-direction: column
    }

    .pc-thumb-info-style-1 .elementor-image-box-description {
        position: relative;
        order: -1;
        margin-bottom: 1rem
    }

    .pc-thumb-info-style-1 .elementor-image-box-description img {
        width: 100%;
        filter: grayscale(1);
        transform: scale(1) !important
    }

    .pc-thumb-info-style-1 .elementor-image-box-description a:after {
        content: "";
        position: absolute;
        top: 0;
        right: 0;
    ...
    .pc-thumb-info-style-1 .elementor-image-box-wrapper .elementor-image-box-img {
        display: block;
        background: #4d4e50;
    ...
    .pc-thumb-info-style-1 .elementor-image-box-img img {
        width: auto;
        margin-left: auto;
        margin-right: auto
    }

    .elementor-inner-column:nth-child(2n) .pc-thumb-info-style-1 .elementor-image-box-img {
        background: #222529
    }

    .pc-thumb-info-style-1:hover .elementor-image-box-img,
    .pc-thumb-info-style-1.active .elementor-image-box-img {
        background-color: #d80d07 !important
    }

    .pc-thumb-info-style-1:hover .elementor-image-box-img img {
        animation: toRightFromLeftNoScale .3s forwards
    }

    .pc-thumb-info-style-1:hover .elementor-image-box-description a:after {
        opacity: 0
    }

    .pc-thumb-info-style-1:hover .elementor-image-box-description img,
    .pc-thumb-info-style-1.active .elementor-image-box-description img {
        filter: grayscale(0)
    }

    .pc-thumb-info-style-1:hover .elementor-image-box-content .elementor-image-box-title {
        color: #d80d07;
        text-decoration: none
    }

    .pc-thumb-info-style-1 .elementor-image-box-title {
        margin-bottom: .25rem
    }

    .pc-thumb-info-style-1 .elementor-image-box-title a:hover {
        text-decoration: none
    }
    ...
    .section-industries .elementor-widget-image-box .elementor-widget-container {
        transition: background .3s;
        min-height: 277px
    }

    .section-industries .elementor-image-box-description {
        transition: color .3s
    }

    .section-industries .elementor-widget-image-box:hover .elementor-widget-container {
        background: #d80d07 !important
    }

    .section-industries .elementor-widget-image-box:hover .elementor-image-box-description {
        color: #fff !important
    }

    .d-col-block>.elementor-widget-wrap,
    .d-col-block>.elementor-column-wrap>.elementor-widget-wrap {
    ...
    .btn-gradient .btn:active {
        background: linear-gradient(135deg, #686bfd 0, #9c41fa 80%)
    }
    </style>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed96e2.json?url=https%3A%2F%2Fbebifydemo.sedmex.com%2Fcontacto%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embedc47c?url=https%3A%2F%2Fbebifydemo.sedmex.com%2Fcontacto%2F&amp;format=xml" />
    ...
    .elementor-1757 .elementor-element.elementor-element-4d1609ac:not(.elementor-motion-effects-element-type-background), .elementor-1757 .elementor-element.elementor-element-4d1609ac > .elementor-motion-effects-container > .elementor-motion-effects-layer {
    background-color: #212529;
}

.elementor-1757 .elementor-element.elementor-element-4d1609ac {
    transition: background 0.3s, border 0.3s, border-radius 0.3s, box-shadow 0.3s;
    padding: 1.25rem 4rem 1.25rem 4rem;
    z-index: 2;
}
.elementor-1757 .elementor-element.elementor-element-4d1609ac, .elementor-1757 .elementor-element.elementor-element-4d1609ac > .elementor-background-overlay {
...
<body data-rsssl=1
    class="page-template-default page page-id-888 wp-custom-logo wp-embed-responsive theme-porto woocommerce-no-js login-popup full blog-1 elementor-default elementor-kit-1724 elementor-page elementor-page-888">
                        ...
                        <div class="breadcrumbs-wrap pt-left">
                            <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                                <li class="home" itemprop="itemListElement" itemscope
                                    itemtype="https://schema.org/ListItem"><a itemprop="item" href="index.html"
                    ...
                    <div class="main-content col-lg-12">
                        ...
                        <div id="content" role="main">
                            ...
                            <article class="post-888 page type-page status-publish hentry">
                                ...
                                <h2 class="entry-title" style="display: none;">Contacto</h2><span class="vcard"
                                    ...
                                    class="updated" style="display:none">2023-11-27T18:59:53+00:00</span>
                                <div class="page-content">
                                    <div data-elementor-type="wp-page" data-elementor-id="888"
                                        class="elementor elementor-888" data-elementor-post-type="page">
                                        <section
                                            class="elementor-section elementor-top-section elementor-element elementor-element-c485627 p-t-xl mt-1 animated-slow elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-invisible"
                                            data-id="c485627" data-element_type="section"
                                            data-settings="{&quot;animation&quot;:&quot;fadeInDown&quot;}">

                                            <div class="elementor-container elementor-column-gap-default">
                                                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-900942d"
                                                    data-id="900942d" data-element_type="column">
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        <div class="elementor-element elementor-element-5ee7ec1 elementor-widget elementor-widget-porto_ultimate_heading"
                                                            data-id="5ee7ec1" data-element_type="widget"
                                                            data-widget_type="porto_ultimate_heading.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="porto-u-heading  porto-u-4275">
                                                                    <div class="porto-u-main-heading">
                                                                        <h2 style="margin-bottom: 5px;">Hola!</h2>
                                                                    </div>
                                                                    <div class="porto-u-sub-heading"
                                                                        style="margin-bottom:30px;">
                                                                        <p>¡Hola!</p>
                                                                        <p>Nos alegra recibir tus mensajes. Si tienes
                                                                            preguntas, sugerencias o necesitas más
                                                                            detalles sobre nuestros productos y
                                                                            servicios, estamos aquí para ayudarte.</p>
                                                                        <p>Utiliza el formulario de contacto o
                                                                            escríbenos a nuestro correo electrónico o
                                                                            WhatsApp.</p>
                                                                        <p><strong>¡Gracias por elegir Bebify! Estamos
                                                                                aquí para ofrecerte la mejor
                                                                                experiencia.</strong></p>
                                                                    </div>
                                                                    <style>
                                                                    .porto-u-4275.porto-u-heading {
                                                                        text-align: left
                                                                    }
                                                                    </style>
                                                                </div>
                                                        ...
                                                        <section
                                                            class="elementor-section elementor-inner-section elementor-element elementor-element-77072b7 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                            data-id="77072b7" data-element_type="section">

                                                            <div
                                                                class="elementor-container elementor-column-gap-default">
                                                                <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-0ac5904"
                                                                    data-id="0ac5904" data-element_type="column">
                                                                    <div
                                                                        class="elementor-widget-wrap elementor-element-populated">
                                                                        <div class="elementor-element elementor-element-d202635 elementor-widget elementor-widget-porto_info_box"
                                                                            data-id="d202635" data-element_type="widget"
                                                                            data-widget_type="porto_info_box.default">
                                                                            <div class="elementor-widget-container">
                                                                                <div
                                                                                    class="porto-sicon-box style_1 top-icon">
                                                                                    <div class="porto-sicon-top">
                                                                                        <div class="porto-just-icon-wrapper porto-icon none"
                                                                                            style="margin-bottom:20px;">
                                                                                            <i
                                                                                                class="Simple-Line-Icons-pointer"></i>
                                                                                        </div>
                                                                                    </div>
                                                                ...
                                                                <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-3875e5c"
                                                                    data-id="3875e5c" data-element_type="column">
                                                                    <div
                                                                        class="elementor-widget-wrap elementor-element-populated">
                                                                        <div class="elementor-element elementor-element-00d639d elementor-widget elementor-widget-porto_info_box"
                                                                            data-id="00d639d" data-element_type="widget"
                                                                            data-widget_type="porto_info_box.default">
                                                                            <div class="elementor-widget-container">
                                                                                <div
                                                                                    class="porto-sicon-box style_1 top-icon">
                                                                ...
                                                                <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-418666f"
                                                                    data-id="418666f" data-element_type="column">
                                                                    <div
                                                                        class="elementor-widget-wrap elementor-element-populated">
                                                                        <div class="elementor-element elementor-element-6ff3b85 elementor-widget__width-initial elementor-widget elementor-widget-porto_info_box"
                                                                            data-id="6ff3b85" data-element_type="widget"
                                                                            data-widget_type="porto_info_box.default">
                                                                            <div class="elementor-widget-container">
                                                                                <div
                                                                                    class="porto-sicon-box style_1 top-icon">
                                                                ...
                                                                <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-14e2fc7"
                                                                    data-id="14e2fc7" data-element_type="column">
                                                                    <div
                                                                        class="elementor-widget-wrap elementor-element-populated">
                                                                        <div class="elementor-element elementor-element-cf91bd6 elementor-widget elementor-widget-porto_info_box"
                                                                            data-id="cf91bd6" data-element_type="widget"
                                                                            data-widget_type="porto_info_box.default">
                                                                            <div class="elementor-widget-container">
                                                                                <div
                                                                                    class="porto-sicon-box style_1 top-icon">
                                                        ...
                                                        <div class="elementor-element elementor-element-169e4f9 elementor-widget-divider--view-line elementor-widget elementor-widget-divider"
                                                            data-id="169e4f9" data-element_type="widget"
                                        ...
                                        <section
                                            class="elementor-section elementor-top-section elementor-element elementor-element-e359dc7 elementor-section-full_width promo-section elementor-section-height-default elementor-section-height-default"
                                            data-id="e359dc7" data-element_type="section">

                                            <div class="elementor-container elementor-column-gap-no">
                                                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-d39f6a4 elementor-invisible"
                                                    data-id="d39f6a4" data-element_type="column"
                                                    data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;animation&quot;:&quot;fadeInLeft&quot;,&quot;animation_delay&quot;:200}">
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        <div class="elementor-element elementor-element-c775cbe elementor-widget elementor-widget-image"
                                                            data-id="c775cbe" data-element_type="widget"
                                                            ...
                                                            <div class="elementor-widget-container">
                                                                ...
                                                                </style> <img decoding="async" width="1024" height="683"
                                                                    src="wp-content/uploads/2023/11/atencion.jpg"
                                                                    class="attachment-full size-full wp-image-3032"
                                                                    alt=""
                                                                    srcset="https://bebifydemo.sedmex.com/wp-content/uploads/2023/11/atencion.jpg 1024w, https://bebifydemo.sedmex.com/wp-content/uploads/2023/11/atencion-768x512.jpg 768w, https://bebifydemo.sedmex.com/wp-content/uploads/2023/11/atencion-640x427.jpg 640w, https://bebifydemo.sedmex.com/wp-content/uploads/2023/11/atencion-400x267.jpg 400w, https://bebifydemo.sedmex.com/wp-content/uploads/2023/11/atencion-600x400.jpg 600w"
                                                                    sizes="(max-width: 1024px) 100vw, 1024px" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-0b2c963 elementor-invisible"
                                                    data-id="0b2c963" data-element_type="column"
                                                    data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;animation&quot;:&quot;fadeInRight&quot;,&quot;animation_delay&quot;:200}">
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        <div class="elementor-element elementor-element-6c8e1d5 elementor-widget elementor-widget-heading"
                                                            data-id="6c8e1d5" data-element_type="widget"
                                                        ...
                                                        <div class="elementor-element elementor-element-c7c5d57 elementor-widget__width-initial elementor-button-align-stretch elementor-widget elementor-widget-form"
                                                            data-id="c7c5d57" data-element_type="widget"
                                                            ...
                                                            <div class="elementor-widget-container">
                                                                ...
                                                                <form class="elementor-form" method="post"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-70 elementor-field-required">
                                                                        ...
                                                                        <div
                                                                            class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_59e05f5 elementor-col-50 elementor-field-required">
                                                                            <label for="form-field-field_59e05f5"
                                                                                class="elementor-field-label">
                                                                                Empresa </label>
                                                                            <input size="1" type="text"
                                                                                name="form_fields[field_59e05f5]"
                                                                                id="form-field-field_59e05f5"
                                                                                class="elementor-field elementor-size-sm  elementor-field-textual"
                                                                                placeholder="Empresa"
                                                                                required="required"
                                                                                aria-required="true">
                                                                        ...
                                                                        <div
                                                                            class="elementor-field-type-textarea elementor-field-group elementor-column elementor-field-group-message elementor-col-70">
                                        ...
                                        <div class="elementor-element elementor-element-07613d2 e-flex e-con-boxed e-con e-parent"
                                            data-id="07613d2" data-element_type="container"
                                            data-settings="{&quot;content_width&quot;:&quot;boxed&quot;}"
                                            data-core-v316-plus="true">
                                            <div class="e-con-inner">
                                                <div class="elementor-element elementor-element-56b5e92 elementor-widget elementor-widget-spacer"
                                                    data-id="56b5e92" data-element_type="widget"
                                        ...
                                        <?php
    include 'componentes/bannerRegistro.php';
?>
...
?>
    ...
    <div id="side-nav-panel" class="">
        ...
        <div class="mobile-tabs">
            <ul class="mobile-tab-items nav nav-fill nav-tabs">
                <li class="mobile-tab-item nav-item active" pane-id="menu-main"><a href="#"
                        rel="nofollow noopener">Categorías</a></li>
                <li class="mobile-tab-item nav-item" pane-id="menu-navigation"><a href="#"
                        rel="nofollow noopener">Nosotros</a></li>
            </ul>
            <div class="mobile-tab-content">
                <div class="menu-wrap tab-pane active" tab-id="menu-main">
                    <ul id="menu-menu-principal-1" class="mobile-menu accordion-menu">
                        <li id="accordion-menu-item-2372"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/aguas/index.html"><i class="fa fa-tint"></i>Aguas</a></li>
                        <li id="accordion-menu-item-2235"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/cervezas/index.html"><i class="fa fa-beer"></i>Cervezas</a></li>
                        <li id="accordion-menu-item-2236"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/destilados/index.html"><i
                                    class="fas fa-glass-cheers"></i>Destilados</a></li>
                        <li id="accordion-menu-item-2241"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/refrescos/index.html"><i
                                    class="fas fa-glass-whiskey"></i>Refrescos</a></li>
                        <li id="accordion-menu-item-2242"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/vinos/index.html"><i
                                    class="fa fa-solid fa-wine-bottle"></i>Vinos</a></li>
                        <li id="accordion-menu-item-2374"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/otras-bebidas/index.html"><i class="fas fa-cocktail"></i>Otras
                                Bebidas</a></li>
                        <li id="accordion-menu-item-2240"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a
                                href="product-category/otros/index.html"><i class="fa fa-shopping-basket"></i>Otros</a>
                        </li>
                    </ul>
                </div>
                <div class="menu-wrap tab-pane" tab-id="menu-navigation">
                    <ul id="menu-secondary-menu-1" class="top-links accordion-menu">
                        <li id="accordion-menu-item-1745"
                            class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                href="productos/index.html">Productos</a></li>
                        <li id="accordion-menu-item-1759"
                            class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                href="conocenos/index.html">Conócenos</a></li>
                        <li id="accordion-menu-item-1746"
                            class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-888 current_page_item active">
                            <a href="index.html" class=" current ">Contáctanos</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    var elementorFrontendConfig = {
        ...
        "post": {
            "id": 888,
            "title": "Contacto%20%E2%80%93%20bebify",
            "excerpt": "",
            "featuredImage": false
        }
    };
...
<!-- Mirrored from bebifydemo.sedmex.com/contacto/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Dec 2023 06:15:53 GMT -->
